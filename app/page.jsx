        ...
        <>
          ...
          <section className="py-10 md:py-12 bg-white border-b border-black/5">
            <div className="max-w-[1600px] mx-auto">
              ...
              <div className="flex justify-center mt-6 px-4">
                <Link href="/shop/kids-girl" className="border border-black px-8 py-3 text-[11px] font-bold tracking-wide uppercase text-black hover:bg-black hover:text-white transition-colors">View Collection</Link>
              </div>
            </div>
          </section>
          )}
          ...
          <section className="py-10 md:py-12 bg-white border-b border-black/5">
            <div className="max-w-[1600px] mx-auto">
              ...
              <div className="flex justify-center mt-6 px-4">
                <Link href="/shop" className="border border-black px-8 py-3 text-[11px] font-bold tracking-wide uppercase text-black hover:bg-black hover:text-white transition-colors">View All</Link>
              </div>
            </div>
          </section>
          )}
            ...
            <div className="w-full relative">
              ...
              {featuredProducts.length === 0 ? (
                ...
                <div className="relative max-w-[1600px] mx-auto group">
                  ...
                  <div ref={carouselRef} className="flex gap-3 md:gap-4 px-4 md:px-8 overflow-x-auto snap-x snap-mandatory pb-4 [&::-webkit-scrollbar]:hidden" style={{ scrollbarWidth: "none" }}>
                    {featuredProducts.map((product, index) => (
                      <div key={`feat-${product.id}-${index}`} className="flex-none w-[70vw] sm:w-[40vw] md:w-[28vw] lg:w-[20vw] snap-start flex flex-col group/card">
                        <div className="relative w-full aspect-[3/4] bg-[#f6f5f3] overflow-hidden mb-3">
                          ...
                          <Link href={`/product/${product.id}`} className="absolute inset-0 w-full h-full">
                            <Image src={product.image_urls?.[0] || "/images/logo.png"} alt={product.title} fill className="object-cover object-center group-hover/card:scale-105 transition-transform duration-700 ease-out" sizes="(max-width: 768px) 70vw, 25vw" />
                          </Link>
                        </div>
                        <Link href={`/product/${product.id}`} className="flex flex-col px-1">
              ...
              <div className="flex justify-center mt-6 px-4">
                <Link href="/shop" className="border border-black px-8 py-3 text-[11px] font-bold tracking-wide uppercase text-black hover:bg-black hover:text-white transition-colors">Discover All</Link>
              </div>
            </div>
          </section>
          )}
