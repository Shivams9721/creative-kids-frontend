            ...
            <div className="w-full relative">
              ...
              {featuredProducts.length === 0 ? (
                ...
                <div className="relative max-w-[1600px] mx-auto group">
                  ...
                  <div ref={carouselRef} className="flex gap-2 sm:gap-3 md:gap-4 px-3 sm:px-4 md:px-8 overflow-x-auto snap-x snap-mandatory pb-3 sm:pb-4 [&::-webkit-scrollbar]:hidden" style={{ scrollbarWidth: "none" }}>
