      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-4 text-center">
        ...
        <div className="flex flex-col items-center justify-start">
          ...
          <div className="flex items-center gap-2 justify-center">
            {/* Visa */}
            <div className="h-[20px] bg-white border border-gray-200 rounded px-1.5 flex items-center justify-center shadow-sm">
            ...
            {/* PayPal */}
            <div className="h-[20px] bg-white border border-gray-200 rounded px-1 flex items-center justify-center shadow-sm">
            ...
            {/* UPI */}
            <div className="h-[20px] bg-white border border-gray-200 rounded px-1.5 flex items-center justify-center shadow-sm">
              <span className="font-bold text-[9px] tracking-tight" style={{ color: "#0F7A59" }}>UPI</span>
            </div>
          </div>
        </div>
